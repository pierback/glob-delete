...
pub const dirs = struct {
    pub const _root = "";
    pub const _2tn0ofycf5sq = cache ++ "/../..";
    pub const _aoe2l16htlue = cache ++ "/git/github.com/Hejsil/zig-clap";
};

pub const package_data = struct {
    pub const _2tn0ofycf5sq = Package{
        .directory = dirs._2tn0ofycf5sq,
    };
...
pub const imports = struct {
    pub const clap = @import(".zigmod/deps/git/github.com/Hejsil/zig-clap/clap.zig");
};
